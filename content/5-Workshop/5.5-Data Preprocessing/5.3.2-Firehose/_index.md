...
3. Under **Choose source and destination**:
   ...
   * **Destination:** Select **Amazon S3**.
   ...
   ![Choose Source and Destination]({{< relURL "images/5-Workshop/5.3-data/5.3.2.1.png" >}})

4. Enter a name for the delivery stream in **Firehose stream name**, for example:

   `local-aqi-dev-firehose-telemetry`

   ![Firehose stream name]({{< relURL "images/5-Workshop/5.3-data/5.3.2.2.png" >}})
...
1. Scroll down to **Destination settings**.
   ...
   ![Select Amazon S3 destination]({{< relURL "images/5-Workshop/5.3-data/5.3.2.3.png" >}})
...
1. Under **Service access**, keep the default option **Create or update IAM role**.
   ...
   ![Configure IAM Role]({{< relURL "images/5-Workshop/5.3-data/5.3.2.5.png" >}})
...
2. Scroll down to **Tags (optional)** and add the following resource tags:
   ...
   * **Key:** `Module` | **Value:** `data`
   ...
   ![Firehose resource tags]({{< relURL "images/5-Workshop/5.3-data/5.3.2.6.png" >}})
...
![Firehose Active status]({{< relURL "images/5-Workshop/5.3-data/5.3.2.7.png" >}})
