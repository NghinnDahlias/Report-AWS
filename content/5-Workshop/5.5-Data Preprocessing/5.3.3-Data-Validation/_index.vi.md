...
![Các file dữ liệu trong Amazon S3]({{< relURL "images/5-Workshop/5.3-data/5.3.3.1.png" >}})
...
![Kết quả chạy chương trình kiểm định dữ liệu]({{< relURL "images/5-Workshop/5.3-data/5.3.3.2.png" >}})
