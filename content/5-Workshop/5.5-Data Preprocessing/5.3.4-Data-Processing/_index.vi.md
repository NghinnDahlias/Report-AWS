...
![Kết quả chạy data_processing.py trên WSL]({{< relURL "images/5-Workshop/5.3-data/5.3.4.1.png" >}})
...
![Tệp Parquet đã được tải lên Amazon S3]({{< relURL "images/5-Workshop/5.3-data/5.3.4.2.png" >}})
